...
function addLimitOrOffsetOptionsToClause({ optionsInput, projectionClause, }) {
    if (optionsInput.limit) {
        projectionClause.limit((0, utils_1.toNumber)(optionsInput.limit));
    }
    if (optionsInput.offset) {
        projectionClause.skip((0, utils_1.toNumber)(optionsInput.offset));
    }
}
exports.addLimitOrOffsetOptionsToClause = addLimitOrOffsetOptionsToClause;
function addSortAndLimitOptionsToClause({ optionsInput, target, projectionClause, }) {
...
function createOrderByParams({ optionsInput, target, }) {
