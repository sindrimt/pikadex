...
export declare type Expr = Operation | Variable | PropertyRef | CypherFunction | Literal | Predicate | ListComprehension | PatternComprehension | MapExpr | MapProjection | ApocExpr;
